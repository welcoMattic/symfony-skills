...
Use **AssetMapper** to manage CSS, JavaScript, and images — not Webpack or Encore. AssetMapper lets you write modern JavaScript and CSS without a build step or bundler complexity.
