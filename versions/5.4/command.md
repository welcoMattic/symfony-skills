...
- **Configure in `configure()`** — set the command name and description in the `configure()` method. The `#[AsCommand]` attribute is not available in Symfony 5.4
...
class ImportUsersCommand extends Command
{
    ...
    protected static $defaultDescription = 'Short description of the command';
...
- Test the command: `symfony console app:import-users`
