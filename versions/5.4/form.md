...
- **Validation on the entity, not the form** — attach `@Assert\...` annotations to the entity properties. This way validation is reused wherever the entity is used, not just in this form
...
Note: In Symfony 5.4, you must call `$form->createView()` when passing the form to the template.
