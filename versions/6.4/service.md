...
- **Readonly:** Use `readonly` on constructor-promoted properties (PHP 8.1+). Note: `readonly class` requires PHP 8.2 — use individual `readonly` properties instead in Symfony 6.4
